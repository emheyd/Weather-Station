class Rec2 {//this is the class for humidity class 
  //define variables
  int x;
  int y;
  int d;
  ...
  //class constructor
  Rec2(int x, int y, int d,float threshold, String text){
    this.x = x;
    this.y = y;
    this.d = d;
  ...
  void displayRec2(){    //drawing an rect
    noStroke();
    fill(255,255,255);
    rect(this.x, this.y, this.d, 400);
    
    float mappedSensorValue = map(sensorValue,0,threshold,0, 400);
